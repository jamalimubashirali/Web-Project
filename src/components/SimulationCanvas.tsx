...
export function SimulationCanvas({
  ...
  useEffect(() => {
    if (
      results &&
      animatingBombs === results.bombs.length &&
      animatingBombs > 0 &&
      isRunning
    ) {
      ...
      <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-6 text-white">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-shadow">Combat Theater</h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 bg-white/10 rounded-lg p-1">
              <button
                onClick={() => setShowExplosions(!showExplosions)}
          ...
          return (
            <div key={bomb.id}>
              ...
              {showCoordinates && (
                ...
                >
                  <div
                    className={`px-2 py-1 rounded text-white text-xs shadow-lg ${
            ...
            <div className="border-t border-gray-200 pt-2 mt-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-semibold text-gray-700">
                  Explosions: {showExplosions ? "ON" : "OFF"}
                </span>
              </div>
          ...
          <div className="space-y-2 text-gray-700">
            <div className="flex justify-between gap-4">
              ...
              <span className="font-bold text-orange-600">
                {currentParams.sigmaX}m
              </span>
            </div>
            <div className="flex justify-between gap-4">
              <span>σᵧ (Vertical):</span>
              <span className="font-bold text-green-600">
                {currentParams.sigmaY}m
              </span>
            </div>
            <div className="flex justify-between gap-4">
              <span>Ordnance:</span>
              <span className="font-bold text-blue-600">
                {results?.totalBombs || currentParams.numBombers}
              </span>
            </div>
            <div className="flex justify-between gap-4">
